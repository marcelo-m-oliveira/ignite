...
var I = { info: function(t2) {
  ...
  return import_react.default.createElement(_, { ...t2 }, import_react.default.createElement("path", { d: "M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z" }));
}, error: function(t2) {
...
function O(e2) {
  ...
  function N2(e3, n2) {
    ...
    if (!y(e3) || function(e4) {
      ...
      return;
    const { toastId: c3, updateId: l2, data: v3 } = i2, { props: _3 } = E2, N3 = () => O2(c3), x2 = l2 == null;
    x2 && E2.count++;
    const R2 = { toastId: c3, updateId: l2, data: v3, containerId: i2.containerId, isLoading: i2.isLoading, theme: i2.theme || _3.theme, icon: i2.icon != null ? i2.icon : _3.icon, isIn: false, key: i2.key || E2.toastKey++, type: i2.type, closeToast: N3, closeButton: i2.closeButton, rtl: _3.rtl, position: i2.position || _3.position, transition: i2.transition || _3.transition, className: f(i2.className || _3.toastClassName), bodyClassName: f(i2.bodyClassName || _3.bodyClassName), style: i2.style || _3.toastStyle, bodyStyle: i2.bodyStyle || _3.bodyStyle, onClick: i2.onClick || _3.onClick, pauseOnHover: d(i2.pauseOnHover) ? i2.pauseOnHover : _3.pauseOnHover, pauseOnFocusLoss: d(i2.pauseOnFocusLoss) ? i2.pauseOnFocusLoss : _3.pauseOnFocusLoss, draggable: d(i2.draggable) ? i2.draggable : _3.draggable, draggablePercent: i2.draggablePercent || _3.draggablePercent, draggableDirection: i2.draggableDirection || _3.draggableDirection, closeOnClick: d(i2.closeOnClick) ? i2.closeOnClick : _3.closeOnClick, progressClassName: f(i2.progressClassName || _3.progressClassName), progressStyle: i2.progressStyle || _3.progressStyle, autoClose: !i2.isLoading && (k2 = i2.autoClose, B2 = _3.autoClose, k2 === false || u(k2) && k2 > 0 ? k2 : B2), hideProgressBar: d(i2.hideProgressBar) ? i2.hideProgressBar : _3.hideProgressBar, progress: i2.progress, role: i2.role || _3.role, deleteToast() {
    ...
    R2.iconOut = function(e4) {
      ...
      return r3 === false || (m(r3) ? i3 = r3(c4) : (0, import_react.isValidElement)(r3) ? i3 = (0, import_react.cloneElement)(r3, c4) : p(r3) || u(r3) ? i3 = r3 : s3 ? i3 = I.spinner() : ((e5) => e5 in I)(o3) && (i3 = I[o3](c4))), i3;
    }(R2), m(i2.onOpen) && (R2.onOpen = i2.onOpen), m(i2.onClose) && (R2.onClose = i2.onClose), R2.closeButton = _3.closeButton, i2.closeButton === false || y(i2.closeButton) ? R2.closeButton = i2.closeButton : i2.closeButton === true && (R2.closeButton = !y(_3.closeButton) || _3.closeButton);
    let M2 = e3;
    (0, import_react.isValidElement)(e3) && !p(e3.type) ? M2 = (0, import_react.cloneElement)(e3, { closeToast: N3, toastProps: R2, data: v3 }) : m(e3) && (M2 = e3({ closeToast: N3, toastProps: R2, data: v3 })), _3.limit && _3.limit > 0 && E2.count > _3.limit && x2 ? E2.queue.push({ toastContent: M2, toastProps: R2, staleId: r2 }) : u(s2) ? setTimeout(() => {
      P2(M2, R2, r2);
    }, s2) : P2(M2, R2, r2);
  }
  ...
  return (0, import_react.useEffect)(() => (E2.containerId = e2.containerId, C.cancelEmit(3).on(0, N2).on(1, (e3) => h2.current && O2(e3)).on(5, _2).emit(2, E2), () => C.emit(3, E2)), []), (0, import_react.useEffect)(() => {
...
function P(e2) {
  ...
  function T2(t2) {
    if (e2.draggable) {
      ...
      const n2 = l.current;
      u2.canCloseOnClick = true, u2.canDrag = true, u2.boundingRect = n2.getBoundingClientRect(), n2.style.transition = "", u2.x = L(t2.nativeEvent), u2.y = N(t2.nativeEvent), e2.draggableDirection === "x" ? (u2.start = u2.x, u2.removalDistance = n2.offsetWidth * (e2.draggablePercent / 100)) : (u2.start = u2.y, u2.removalDistance = n2.offsetHeight * (e2.draggablePercent === 80 ? 1.5 * e2.draggablePercent : e2.draggablePercent / 100));
    }
  }
  function v2() {
    if (u2.boundingRect) {
  ...
  function C2(t2) {
    const n2 = l.current;
    u2.canDrag && n2 && (u2.didMove = true, o2 && b2(), u2.x = L(t2), u2.y = N(t2), u2.delta = e2.draggableDirection === "x" ? u2.x - u2.start : u2.y - u2.start, u2.start !== u2.x && (u2.canCloseOnClick = false), n2.style.transform = "translate" + e2.draggableDirection + "(" + u2.delta + "px)", n2.style.opacity = "" + (1 - Math.abs(u2.delta / u2.removalDistance)));
  }
  function _2() {
  ...
  }), { playToast: E2, pauseToast: b2, isRunning: o2, preventExitTransition: r2, toastRef: l, eventHandlers: I2 };
}
function x(t2) {
...
var k = (t2) => {
  const { isRunning: n2, preventExitTransition: o2, toastRef: s2, eventHandlers: a2 } = P(t2), { closeButton: r2, children: i2, autoClose: c2, onClick: u2, type: d2, hideProgressBar: p2, closeToast: f2, transition: g2, position: y2, className: h2, style: T2, bodyClassName: v2, bodyStyle: E2, progressClassName: b2, progressStyle: C2, updateId: _2, role: I2, progress: O2, rtl: L2, toastId: N2, deleteToast: k2, isIn: B2, isLoading: M2, iconOut: D2, theme: w2 } = t2, A2 = clsx_m_default("Toastify__toast", "Toastify__toast-theme--" + w2, "Toastify__toast--" + d2, { "Toastify__toast--rtl": L2 }), F2 = m(h2) ? h2({ rtl: L2, position: y2, type: d2, defaultClassName: A2 }) : clsx_m_default(A2, h2), S2 = !!O2, z2 = { closeToast: f2, type: d2, theme: w2 };
  let H2 = null;
  return r2 === false || (H2 = m(r2) ? r2(z2) : import_react.default.isValidElement(r2) ? import_react.default.cloneElement(r2, z2) : x(z2)), import_react.default.createElement(g2, { isIn: B2, done: k2, position: y2, preventExitTransition: o2, nodeRef: s2 }, import_react.default.createElement("div", { id: N2, onClick: u2, className: F2, ...a2, style: T2, ref: s2 }, import_react.default.createElement("div", { ...B2 && { role: I2 }, className: m(v2) ? v2({ type: d2 }) : clsx_m_default("Toastify__toast-body", v2), style: E2 }, D2 != null && import_react.default.createElement("div", { className: clsx_m_default("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !M2 }) }, D2), import_react.default.createElement("div", null, i2)), H2, (c2 || S2) && import_react.default.createElement(R, { ..._2 && !S2 ? { key: "pb-" + _2 } : {}, rtl: L2, theme: w2, delay: c2, isRunning: n2, isIn: B2, closeToast: f2, hide: p2, type: d2, style: C2, className: b2, controlledProgress: S2, progress: O2 })));
};
...
var A = (0, import_react.forwardRef)((t2, n2) => {
  const { getToastToRender: o2, containerRef: a2, isToastActive: r2 } = O(t2), { className: i2, style: c2, rtl: u2, containerId: d2 } = t2;
  function p2(e2) {
  ...
  return (0, import_react.useEffect)(() => {
    ...
    return import_react.default.createElement("div", { className: p2(t3), style: o3, key: "container-" + t3 }, n3.map((t4, o4) => {
      ...
      return import_react.default.createElement(k, { ...a3, isIn: r2(a3.toastId), style: { ...a3.style, "--nth": o4 + 1, "--len": n3.length }, key: "toast-" + a3.key }, s2);
    }));
  }));
});
...
W.loading = (e2, t2) => U(e2, Q(T.DEFAULT, { isLoading: true, autoClose: false, closeOnClick: false, closeButton: false, draggable: false, ...t2 })), W.promise = function(e2, t2, n2) {
  ...
  const i2 = { isLoading: null, autoClose: null, closeOnClick: null, closeButton: null, draggable: null, delay: 100 }, c2 = (e3, t3, s3) => {
    ...
    const a3 = { type: e3, ...i2, ...n2, data: s3 }, r3 = p(t3) ? { render: t3 } : t3;
    return o2 ? W.update(o2, { ...a3, ...r3 }) : W(r3.render, { ...a3, ...r3 }), s3;
  }, l = m(e2) ? e2() : e2;
